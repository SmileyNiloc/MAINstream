...
Dont assign a rank until all prompts are evaluated.
IMPORTANT: ALWAYS RESPOND IN ENGLISH.
...
class Ranker:
    """
    Ranks LLM responses using Gemini as the judge.
    Falls back to a neutral score of 5 if the API call fails.
    """

    def __init__(self, gemini_api_key: str = None, model: str = "qwen2.5:7b"):
        self._model = model
